...
@Actor22(name = ApplData.robotName,contextName="pcCtx",implement = BoundaryCleanerAnnotation.class)
//@Actor22(name = "sentinel",contextName="pcCtx",implement = Sentinel.class)
public class MainBoundaryCleanerAnnotation { 
 ...
 */
	public static void main(String[] args) throws Exception   {
		CommUtils.aboutThreads("Before start - ");
 		new MainBoundaryCleanerAnnotation().configure();
